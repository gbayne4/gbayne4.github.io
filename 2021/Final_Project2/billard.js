...
if (keyIsPressed === true){
	...
	if (line1 === true && count == 1 && keyIsPressed === true){
			//chat bar
	fill(0)
	rect(0,placement-100,windowWidth,windowHeight)
		line0 = false;
...
if (keyIsPressed === true){
	...
	if (line2 === true && count == 2 && keyIsPressed === true){
			//chat bar
	fill(0)
	rect(0,placement-100,windowWidth,windowHeight)
		line1 = false;
  ...
  textFont(font, 30);
	...
	text('“Yeah yeah I know the drill”', width / 2, placement);
		...
		if (line3 === true && count == 3 && keyIsPressed === true ){
			//chat bar
	fill(0)
	rect(0,placement-100,windowWidth,windowHeight)
		line2 = false;
  ...
  textFont(font, 30);
	fill('#8B7734')
	text('“Shes always there stalking this one portait. Only god knows why, but I only saw Ms. Peacock”', width / 2, placement);
	if (keyIsPressed === true){
	count =4
}
	}
  ...
  textFont(font, 30);
	...
	text('"This conversations lost my interest. Im going to play pool instead”', width / 2, placement);
	count = 0	
	if (keyIsPressed === true){
	count =1
}
  ...
  textFont(font, 30);
	fill('#8B7734')
	text('"Yeah, by the sound of people entering and exiting the study. People are always in and out of there”', width / 2, placement);
	if (keyIsPressed === true){
	count =3
}
	} 
  ...
  textFont(font, 30);
	fill('#8B7734')
	text('"Plum always find his way in there. Not too sure why."', width / 2, placement);
	text('Anyway, those are enough thoughts to last me forver.', width / 2, placement +50);
	text('Im going to resume my pool game' , width / 2, placement +100);
	count = 0	
	if (keyIsPressed === true){
	count =1
}
  ...
  textFont(font, 30);
	fill('#8B7734')
	text('“Well, thatd be the most obvious place, if it were me, Id go to the opposite end."', width / 2, placement);
	count = 0
	if (keyIsPressed === true){
	count =1
}	
  ...
  textFont(font, 30);
	fill('#8B7734')
	text(' “Of course, she a very attractive woman. Low class, but attractive.”', width / 2, placement);
	text('Anyway, those are enough thoughts to last me forver.', width / 2, placement +50);
	text('Im going to resume my pool game' , width / 2, placement +100);
	count = 0	
	if (keyIsPressed === true){
